...
pub enum Error {
    ...
    EcdsaSig(bitcoin::ecdsa::ParseSignatureError),
...
#[doc(hidden)]
impl From<bitcoin::ecdsa::ParseSignatureError> for Error {
    fn from(e: bitcoin::ecdsa::ParseSignatureError) -> Error { Error::EcdsaSig(e) }
}
